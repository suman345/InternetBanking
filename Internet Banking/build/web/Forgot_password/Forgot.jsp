<%-- 
    Document   : Forgot
    Created on : Feb 8, 2020, 1:15:56 PM
    Author     : Sumanpc
--%>
<%
        int err=0;
    try{
            String msg =request.getParameter("mas");
            if(msg.equals("Error5"))
            {
                err=1;
            }
        }
...
<!------ Include the above in your HEAD tag ---------->
 ...
 <script>
    function value()
    {
        document.getElementById('err').innerHTML="Email ID entered by you does not exist or is incorrect, kindly check the ID and try again.";
    }
 </script>   
    </head>
